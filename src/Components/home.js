      ...
      <div className="home-container">
        ...
        <div className="home-row">
          <Product
            ...
            price={199.99}
            image="https://m.media-amazon.com/images/I/61-foZT3rkL._AC_UY327_FMwebp_QL65_.jpg"
            rating={4}
          />
          <Product
            id="56123456"
        ...
        <div className="home-row">
          <Product
            id="23445930"
            title="Amazon Egho (3rd generation) | Smart speaker with Alexa, Charcoal Fabric"
            price={98.99}
            image="https://m.media-amazon.com/images/I/61rNSKloy2L._AC_UY327_FMwebp_QL65_.jpg"
            rating={5}
          />
          <Product
            id="3254354345"
          ...
          <Product
            id="123456789"
            title="Stone Lain Brighton 16-Piece Dinnerware Set Porcelain, Pink"
            price={74.96}
            image="https://m.media-amazon.com/images/I/71uyu7KfVvL._AC_UL600_FMwebp_QL65_.jpg"
            rating={3}
          />
        </div>
        <div className="home-row">
